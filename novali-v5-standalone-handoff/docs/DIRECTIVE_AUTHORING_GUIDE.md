...
This guide is for operators preparing a formal directive file for the standalone `novali-v5` package.
...
.\standalone_docker\generate_directive_scaffold.ps1 `
  ...
  --clarified-intent-summary "Bootstrap novali-v5 through the canonical operator flow and preserve governed artifact authority before execution."
```

This writes a formal directive wrapper that already includes:

- the current `novali-v5` bootstrap context
