...
def _build_loop_candidate_examples_v7(
    *,
    ...
    return [
        {
            "loop_candidate_id": "loop_candidate_governance_recommendation_frontier_circularity_boundary_audit",
            "loop_candidate_name": "Governance recommendation-frontier circularity boundary audit",
            "loop_candidate_summary": "audit whether the recommendation frontier remains circularity-bounded, materially distinct, and structurally yielding after the successful frontier-recursion execution rather than collapsing into circular governance motion, diminishing-return paperwork, or pressure toward posture broadening",
            "proposed_execution_template": "proposal_learning_loop.v4_governed_work_loop_governance_recommendation_frontier_circularity_boundary_audit_v1",
            ...
            "expected_success_signal": "a bounded frontier-circularity artifact showing whether the current recommendation frontier stays circularity-bounded, structurally useful, and evidence-yielding across successive bounded executions without widening execution",
            ...
            "distinctness_basis": "tests recommendation-frontier circularity boundaries after frontier recursion rather than repeating state coherence, raw ledger consistency, recommendation-to-ledger alignment, frontier containment, frontier stability, frontier persistence, frontier recursion, or evidence consolidation",
            ...
            "distinct_from_continuation_v3": True,
            "distinct_from_evidence_snapshot_v3": True,
            "distinct_from_continuation_v4": True,
            "distinct_from_evidence_snapshot_v4": True,
            "distinct_from_continuation_v5": True,
            "distinct_from_evidence_snapshot_v5": True,
            "distinct_from_continuation_v6": True,
            "distinct_from_evidence_snapshot_v6": True,
        ...
        {
            "loop_candidate_id": "loop_candidate_repeat_recommendation_frontier_recursion_boundary_without_circularity_signal",
            "loop_candidate_name": "Repeat recommendation-frontier recursion boundary audit with no circularity signal",
            "loop_candidate_summary": "restate the current recursion-bounded frontier without a new circularity-boundary question or a new bounded operational signal",
            ...
            "expected_success_signal": "another recursion-oriented pass that mostly rephrases current governance conclusions without a new bounded circularity signal",
            "touches_protected_surface": False,
            "touches_downstream_selected_set": False,
            "touches_plan_ownership": False,
            "touches_routing": False,
            "touches_branch_state": False,
            "unbounded_contextual_exploration": False,
            "distinctness_basis": "materially overlaps the frontier-recursion execution and evidence v6 while introducing no new frontier-facing bounded question",
            "distinct_from_direct_work": True,
            ...
            "distinct_from_continuation_v3": False,
            "distinct_from_evidence_snapshot_v3": False,
            "distinct_from_continuation_v4": False,
            "distinct_from_evidence_snapshot_v4": False,
            "distinct_from_continuation_v5": False,
            "distinct_from_evidence_snapshot_v5": False,
            "distinct_from_continuation_v6": False,
            "distinct_from_evidence_snapshot_v6": False,
        ...
        {
            "loop_candidate_id": "loop_candidate_high_consequence_governance_frontier_circularity_exception_support",
            "loop_candidate_name": "High-consequence governance frontier circularity exception support",
            "loop_candidate_summary": "perform a bounded but decision-critical frontier-circularity exception support task whose consequence profile requires explicit review before continuation",
            "proposed_execution_template": "",
            "directive_relevance": "high",
            "support_vs_drift": "support",
            "trusted_sources": ["local_artifacts:novali-v4/data"],
            ...
            "expected_incremental_value": "medium",
            "repeats_low_yield_narrow_shape": False,
            "expected_success_signal": "a bounded frontier-circularity exception-support output only if review clears the consequence profile",
            "touches_protected_surface": False,
            "touches_downstream_selected_set": False,
            "touches_plan_ownership": False,
            "touches_routing": False,
        ...
        {
            "loop_candidate_id": "loop_candidate_local_trace_parser_frontier_circularity_trace_extension",
            "loop_candidate_name": "Local trace parser frontier-circularity trace extension",
            "loop_candidate_summary": "extend the paused parser capability to a new frontier-circularity trace family inside the governed loop",
            "proposed_execution_template": "",
            "directive_relevance": "high",
            "support_vs_drift": "support",
            "trusted_sources": ["local_artifacts:novali-v4/data", "local_logs:logs"],
        ...
        {
            "loop_candidate_id": "loop_candidate_cross_artifact_recommendation_frontier_circularity_lineage_reconstruction",
            "loop_candidate_name": "Cross-artifact recommendation-frontier circularity lineage reconstruction",
        ...
        {
            "loop_candidate_id": "loop_candidate_broad_multi_path_recommendation_frontier_circularity_expansion_sweep",
            "loop_candidate_name": "Broad multi-path recommendation-frontier circularity expansion sweep",
            "loop_candidate_summary": "attempt to combine direct work, capability reuse, posture review, and exploratory frontier expansion in one step",
            "proposed_execution_template": "",
...
def _next_path_for_loop_class_v4(class_name: str) -> dict[str, Any]:
    if class_name == "loop_continue_candidate":
        return {
            "next_template": "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v7",
            "path_type": "work_loop_continuation_admission",
            "reason": "the strongest remaining bounded candidate should advance into the next governed work-loop continuation admission gate later while the current narrow posture remains unchanged",
        }
...
def _posture_rule_application_v4(
    ...
    *,
    ...
    return {
        ...
        "distinct_bounded_next_step_rule": {
            ...
            "reason": (
                "the candidate adds a distinct bounded next-step signal beyond the current seven-step chain, including frontier-containment, frontier-stability, frontier-persistence, frontier-recursion, and the v6 evidence layer"
...
def _screen_loop_candidate_v4(
    ...
    *,
    ...
    next_path = _next_path_for_loop_class_v4(assigned_class)
    ...
    materially_distinct_from_chain = all(
        [
            ...
            bool(candidate.get("distinct_from_continuation_v3", False)),
            bool(candidate.get("distinct_from_evidence_snapshot_v3", False)),
            bool(candidate.get("distinct_from_continuation_v4", False)),
            bool(candidate.get("distinct_from_evidence_snapshot_v4", False)),
            bool(candidate.get("distinct_from_continuation_v5", False)),
            bool(candidate.get("distinct_from_evidence_snapshot_v5", False)),
            bool(candidate.get("distinct_from_continuation_v6", False)),
            bool(candidate.get("distinct_from_evidence_snapshot_v6", False)),
        ]
    )
    screened["next_path"] = next_path
    screened["posture_rule_application"] = _posture_rule_application_v4(
        candidate,
    ...
    screened["screen_dimensions"]["distinctness_vs_reviewed_chain"] = {
        ...
        "distinct_from_continuation_v3": bool(candidate.get("distinct_from_continuation_v3", False)),
        "distinct_from_evidence_snapshot_v3": bool(candidate.get("distinct_from_evidence_snapshot_v3", False)),
        "distinct_from_continuation_v4": bool(candidate.get("distinct_from_continuation_v4", False)),
        "distinct_from_evidence_snapshot_v4": bool(candidate.get("distinct_from_evidence_snapshot_v4", False)),
        "distinct_from_continuation_v5": bool(candidate.get("distinct_from_continuation_v5", False)),
        "distinct_from_evidence_snapshot_v5": bool(candidate.get("distinct_from_evidence_snapshot_v5", False)),
        "distinct_from_continuation_v6": bool(candidate.get("distinct_from_continuation_v6", False)),
        "distinct_from_evidence_snapshot_v6": bool(candidate.get("distinct_from_evidence_snapshot_v6", False)),
    ...
    screened["loop_accounting_expectations"]["loop_identity_context"]["loop_iteration"] = "after_seven_step_chain_evidence_v6"
    screened["loop_accounting_expectations"]["current_work_state"].update(
        {
            ...
            "prior_loop_continuation_v3": str(dict(loop_chain_state.get("continuation_v3", {})).get("loop_candidate_name", "")),
            "prior_loop_continuation_v4": str(dict(loop_chain_state.get("continuation_v4", {})).get("loop_candidate_name", "")),
            "prior_loop_continuation_v5": str(dict(loop_chain_state.get("continuation_v5", {})).get("loop_candidate_name", "")),
            "prior_loop_continuation_v6": str(dict(loop_chain_state.get("continuation_v6", {})).get("loop_candidate_name", "")),
...
def run_probe(cfg, proposal, *, rounds, seeds):
    ...
    work_loop_candidate_screen_snapshot_v6 = r._load_latest_diagnostic_artifact_by_template(
        "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v6"
    )
    work_loop_continuation_admission_snapshot_v6 = r._load_latest_diagnostic_artifact_by_template(
    ...
    work_loop_evidence_snapshot_v3 = r._load_latest_diagnostic_artifact_by_template(
        "memory_summary.v4_governed_work_loop_evidence_snapshot_v3"
    )
    work_loop_evidence_snapshot_v4 = r._load_latest_diagnostic_artifact_by_template(
        "memory_summary.v4_governed_work_loop_evidence_snapshot_v4"
    )
    work_loop_evidence_snapshot_v5 = r._load_latest_diagnostic_artifact_by_template(
        "memory_summary.v4_governed_work_loop_evidence_snapshot_v5"
    )
    work_loop_evidence_snapshot_v6 = r._load_latest_diagnostic_artifact_by_template(
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_snapshot_v6,
            work_loop_continuation_admission_snapshot_v6,
            work_loop_execution_snapshot_v1,
            work_loop_execution_snapshot_v2,
            work_loop_execution_snapshot_v3,
            work_loop_execution_snapshot_v4,
            work_loop_execution_snapshot_v5,
            work_loop_execution_snapshot_v6,
            work_loop_evidence_snapshot_v1,
            work_loop_evidence_snapshot_v2,
            work_loop_evidence_snapshot_v3,
            work_loop_evidence_snapshot_v4,
            work_loop_evidence_snapshot_v5,
            work_loop_evidence_snapshot_v6,
        ...
        return {
            ...
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v7 requires the strengthened seven-step chain, evidence v6, posture v1, v6 candidate screen, v6 continuation admission, direct-work evidence, and capability-use evidence artifacts",
            "observability_gain": {"passed": False, "reason": "missing prerequisite governed work-loop v7 candidate-screen artifacts"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite governed work-loop v7 candidate-screen artifacts"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite governed work-loop v7 candidate-screen artifacts"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot screen a seventh bounded continuation frontier without the full narrow-posture evidence chain"},
        }
    ...
    if not all([directive_state, bucket_state, self_structure_state, branch_registry]):
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v7 requires current directive, bucket, self-structure, and branch artifacts",
    ...
    if not governed_work_loop_policy or not governed_capability_use_policy or not governed_directive_work_selection_policy:
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v7 requires current work-loop, capability-use, and directive-work governance state",
    ...
    work_loop_policy_artifact_path = _resolve_artifact_path_for_pattern(
        governed_work_loop_policy.get("last_policy_artifact_path"),
        "memory_summary_v4_governed_work_loop_policy_snapshot_v1_*.json",
    )
    work_loop_candidate_screen_v6_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    work_loop_continuation_admission_v6_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    work_loop_execution_v6_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    work_loop_evidence_v3_artifact_path = _resolve_artifact_path(
        None,
        "memory_summary_v4_governed_work_loop_evidence_snapshot_v3_*.json",
    )
    work_loop_evidence_v4_artifact_path = _resolve_artifact_path(
        None,
        "memory_summary_v4_governed_work_loop_evidence_snapshot_v4_*.json",
    )
    work_loop_evidence_v5_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    work_loop_evidence_v6_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    work_loop_posture_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_v6_artifact_path,
            work_loop_continuation_admission_v6_artifact_path,
            work_loop_execution_v1_artifact_path,
            work_loop_execution_v2_artifact_path,
            work_loop_execution_v3_artifact_path,
            work_loop_execution_v4_artifact_path,
            work_loop_execution_v5_artifact_path,
            work_loop_execution_v6_artifact_path,
            work_loop_evidence_v1_artifact_path,
            work_loop_evidence_v2_artifact_path,
            work_loop_evidence_v3_artifact_path,
            work_loop_evidence_v4_artifact_path,
            work_loop_evidence_v5_artifact_path,
            work_loop_evidence_v6_artifact_path,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: one or more governed work-loop v7 reference artifact paths could not be resolved",
            "observability_gain": {"passed": False, "reason": "missing resolved artifact paths for work-loop screening v7"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing resolved artifact paths for work-loop screening v7"},
            "ambiguity_reduction": {"passed": False, "reason": "missing resolved artifact paths for work-loop screening v7"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
    ...
    work_loop_candidate_screen_v6_payload = _load_json_file(work_loop_candidate_screen_v6_artifact_path)
    work_loop_continuation_admission_v6_payload = _load_json_file(work_loop_continuation_admission_v6_artifact_path)
    ...
    work_loop_execution_v3_payload = _load_json_file(work_loop_execution_v3_artifact_path)
    work_loop_execution_v4_payload = _load_json_file(work_loop_execution_v4_artifact_path)
    work_loop_execution_v5_payload = _load_json_file(work_loop_execution_v5_artifact_path)
    work_loop_execution_v6_payload = _load_json_file(work_loop_execution_v6_artifact_path)
    ...
    work_loop_evidence_v3_payload = _load_json_file(work_loop_evidence_v3_artifact_path)
    work_loop_evidence_v4_payload = _load_json_file(work_loop_evidence_v4_artifact_path)
    work_loop_evidence_v5_payload = _load_json_file(work_loop_evidence_v5_artifact_path)
    work_loop_evidence_v6_payload = _load_json_file(work_loop_evidence_v6_artifact_path)
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_v6_payload,
            work_loop_continuation_admission_v6_payload,
            work_loop_execution_v1_payload,
            work_loop_execution_v2_payload,
            work_loop_execution_v3_payload,
            work_loop_execution_v4_payload,
            work_loop_execution_v5_payload,
            work_loop_execution_v6_payload,
            work_loop_evidence_v1_payload,
            work_loop_evidence_v2_payload,
            work_loop_evidence_v3_payload,
            work_loop_evidence_v4_payload,
            work_loop_evidence_v5_payload,
            work_loop_evidence_v6_payload,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v7 could not load one or more governing payloads",
            "observability_gain": {"passed": False, "reason": "missing prerequisite summary payloads for work-loop screening v7"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite summary payloads for work-loop screening v7"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite summary payloads for work-loop screening v7"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot screen the next frontier without the v6 evidence chain payloads"},
        }

    work_loop_policy_summary = dict(work_loop_policy_payload.get("governed_work_loop_policy_summary", {}))
    work_loop_candidate_screen_v6_summary = dict(
        work_loop_candidate_screen_v6_payload.get("governed_work_loop_candidate_screen_v6_summary", {})
    )
    work_loop_continuation_admission_v6_summary = dict(
        work_loop_continuation_admission_v6_payload.get("governed_work_loop_continuation_admission_v6_summary", {})
    )
    ...
    work_loop_execution_v3_summary = dict(
        work_loop_execution_v3_payload.get("governed_work_loop_continuation_execution_summary", {})
    )
    work_loop_execution_v4_summary = dict(
        work_loop_execution_v4_payload.get("governed_work_loop_continuation_execution_summary", {})
    )
    work_loop_execution_v5_summary = dict(
        work_loop_execution_v5_payload.get("governed_work_loop_continuation_execution_summary", {})
    )
    work_loop_execution_v6_summary = dict(
        work_loop_execution_v6_payload.get("governed_work_loop_continuation_execution_summary", {})
    )
    ...
    work_loop_evidence_v3_summary = dict(work_loop_evidence_v3_payload.get("governed_work_loop_evidence_v3_summary", {}))
    work_loop_evidence_v4_summary = dict(work_loop_evidence_v4_payload.get("governed_work_loop_evidence_v4_summary", {}))
    work_loop_evidence_v5_summary = dict(work_loop_evidence_v5_payload.get("governed_work_loop_evidence_v5_summary", {}))
    work_loop_evidence_v6_summary = dict(work_loop_evidence_v6_payload.get("governed_work_loop_evidence_v6_summary", {}))
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_v6_summary,
            work_loop_continuation_admission_v6_summary,
            work_loop_execution_v1_summary,
            work_loop_execution_v2_summary,
            work_loop_execution_v3_summary,
            work_loop_execution_v4_summary,
            work_loop_execution_v5_summary,
            work_loop_execution_v6_summary,
            work_loop_evidence_v1_summary,
            work_loop_evidence_v2_summary,
            work_loop_evidence_v3_summary,
            work_loop_evidence_v4_summary,
            work_loop_evidence_v5_summary,
            work_loop_evidence_v6_summary,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v7 could not load the governing summaries",
            "observability_gain": {"passed": False, "reason": "missing prerequisite work-loop v7 summaries"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite work-loop v7 summaries"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite work-loop v7 summaries"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
    ...
    future_posture_review_gate = dict(work_loop_evidence_v6_summary.get("gate_status", {}))
    loop_chain_state = dict(work_loop_evidence_v6_summary.get("chain_state_reviewed", {}))
    diminishing_returns_classification = str(
        dict(work_loop_evidence_v6_summary.get("diminishing_returns_assessment", {})).get(
            "classification",
            "not_nearing_diminishing_returns",
        )
    )
    circularity_risk_classification = str(
        dict(work_loop_evidence_v6_summary.get("circularity_risk_assessment", {})).get(
            "classification",
            "circularity_risk_low",
        )
    )
    frontier_nearing_diminishing_returns = diminishing_returns_classification == "nearing_diminishing_returns"
    circularity_risk_not_low = circularity_risk_classification not in {"circularity_risk_low", "low"}
    ready_for_candidate_screen_v7 = (
        ...
        and not bool(dict(work_loop_evidence_v6_summary.get("future_posture", {})).get("broader_execution_opened", True))
        and str(dict(work_loop_evidence_v6_summary.get("chain_distinct_value_assessment", {})).get("classification", "")) == "accumulating_distinct_value"
        and str(dict(work_loop_evidence_v6_summary.get("repeated_bounded_success_assessment", {})).get("classification", "")) == "repeated_bounded_success_strengthened"
        and str(dict(work_loop_evidence_v6_summary.get("posture_discipline_assessment", {})).get("classification", "")) == "posture_discipline_holding_cleanly"
        and str(dict(work_loop_evidence_v6_summary.get("posture_pressure_assessment", {})).get("classification", "")) == "posture_pressure_absent"
        and str(dict(work_loop_evidence_v6_summary.get("new_execution_signal_assessment", {})).get("classification", "")) == "materially_improved_evidence_picture"
        and not frontier_nearing_diminishing_returns
        and not circularity_risk_not_low
        and str(future_posture_review_gate.get("gate_status", "")) == "defined_but_closed"
    )
    if not ready_for_candidate_screen_v7:
        return {
            "passed": False,
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: current state is not yet marked ready for governed work-loop candidate screening v7",
            "observability_gain": {"passed": False, "reason": "v7 candidate-frontier readiness is not yet established"},
            "activation_analysis_usefulness": {"passed": False, "reason": "v7 candidate-frontier readiness is not yet established"},
            "ambiguity_reduction": {"passed": False, "reason": "v7 candidate-frontier readiness is not yet established"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "the current seven-step chain, posture, evidence v6, and low circularity/diminishing-return readings must all remain aligned before screening another bounded frontier"},
        }
    ...
    loop_continuation_future_posture = str(dict(work_loop_evidence_v6_summary.get("future_posture", {})).get("category", ""))
    ...
    screen_schema = {
        ...
        "schema_version": "governed_work_loop_candidate_screen_v7",
        "required_fields": [
            "loop_candidate_id",
            "loop_candidate_name",
    ...
    frontier_nearing_diminishing_returns_or_circularity = frontier_nearing_diminishing_returns or circularity_risk_not_low
    best_candidate = (
    ...
    ready_for_next_bounded_step_admission = credible_candidate_present and not frontier_nearing_diminishing_returns_or_circularity
    stop_continuation = (not credible_candidate_present) and frontier_nearing_diminishing_returns_or_circularity
    recommended_next_action_class = (
        "bounded_continuation_admission_later"
        if ready_for_next_bounded_step_admission
        else ("stop_continuation" if stop_continuation else "hold_posture")
    )
    next_template = (
    ...
    artifact_path = _diagnostic_artifact_dir() / f"memory_summary_v4_governed_work_loop_candidate_screen_snapshot_v7_{proposal['proposal_id']}.json"

    updated_self_structure_state = dict(self_structure_state)
    updated_work_loop_policy = dict(governed_work_loop_policy)
    updated_work_loop_policy["work_loop_candidate_screen_v7_schema"] = screen_schema
    updated_work_loop_policy["work_loop_candidate_screen_schema"] = screen_schema
    updated_work_loop_policy["last_prior_candidate_screen_artifact_path"] = str(work_loop_candidate_screen_v6_artifact_path)
    ...
    updated_work_loop_policy["last_candidate_screen_outcome"] = {
        "status": "credible_next_bounded_candidate_identified_v7" if ready_for_next_bounded_step_admission else "candidate_frontier_weak_v7",
        ...
        "bounded_candidate_search_later_supported": ready_for_next_bounded_step_admission,
        "diminishing_returns_assessment": diminishing_returns_classification,
        "circularity_risk_assessment": circularity_risk_classification,
        "reason": (
            "one credible next bounded continuation candidate remains after screening and the frontier is not nearing diminishing returns or circularity"
            if ready_for_next_bounded_step_admission
            else (
                "the candidate frontier is now too weak, diminishing-return, or circular enough that posture should hold"
                if not stop_continuation
                else "the candidate frontier is weak enough under diminishing-return or circularity pressure that continuation should stop"
            )
        ),
    }
    ...
    updated_current_state_summary.update(
        {
            "governed_work_loop_candidate_screening_v7_in_place": True,
            "latest_governed_work_loop_candidate_screen_outcome": (
                "credible_next_bounded_candidate_identified_v7" if ready_for_next_bounded_step_admission else "candidate_frontier_weak_v7"
            ),
            ...
            "latest_governed_work_loop_continuation_readiness": (
                "ready_for_seventh_governed_work_loop_continuation_admission"
                if ready_for_next_bounded_step_admission
                else "candidate_frontier_weak_hold"
            ),
            "latest_governed_work_loop_recommended_next_action_class": recommended_next_action_class,
            "latest_governed_work_loop_readiness": (
                "ready_for_seventh_governed_work_loop_continuation_admission"
                if ready_for_next_bounded_step_admission
                else ("stop_continuation" if stop_continuation else "hold_narrow_posture")
            ),
    ...
    ledger_event = {
        "event_id": f"governed_work_loop_candidate_screen_snapshot_v7::{proposal['proposal_id']}",
        "timestamp": _now(),
        "event_type": "governed_work_loop_candidate_screen_snapshot_v7_materialized",
        ...
        "artifact_paths": {
            ...
            "governed_work_loop_candidate_screen_v6": str(work_loop_candidate_screen_v6_artifact_path),
            "governed_work_loop_continuation_admission_v6": str(work_loop_continuation_admission_v6_artifact_path),
            ...
            "governed_work_loop_execution_v3": str(work_loop_execution_v3_artifact_path),
            "governed_work_loop_execution_v4": str(work_loop_execution_v4_artifact_path),
            "governed_work_loop_execution_v5": str(work_loop_execution_v5_artifact_path),
            "governed_work_loop_execution_v6": str(work_loop_execution_v6_artifact_path),
            ...
            "governed_work_loop_evidence_v3": str(work_loop_evidence_v3_artifact_path),
            "governed_work_loop_evidence_v4": str(work_loop_evidence_v4_artifact_path),
            "governed_work_loop_evidence_v5": str(work_loop_evidence_v5_artifact_path),
            "governed_work_loop_evidence_v6": str(work_loop_evidence_v6_artifact_path),
            ...
            "governed_work_loop_candidate_screen_v7": str(artifact_path),
        },
    ...
    artifact_payload = {
        ...
        "template_name": "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v7",
        ...
        "comparison_references": {
            ...
            "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v6": _artifact_reference(work_loop_candidate_screen_snapshot_v6, latest_snapshots),
            "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v6": _artifact_reference(work_loop_continuation_admission_snapshot_v6, latest_snapshots),
            ...
            "proposal_learning_loop.v4_governed_work_loop_governance_recommendation_frontier_containment_audit_v1": _artifact_reference(work_loop_execution_snapshot_v3, latest_snapshots),
            "proposal_learning_loop.v4_governed_work_loop_governance_recommendation_frontier_stability_delta_audit_v1": _artifact_reference(work_loop_execution_snapshot_v4, latest_snapshots),
            "proposal_learning_loop.v4_governed_work_loop_governance_recommendation_frontier_persistence_boundary_audit_v1": _artifact_reference(work_loop_execution_snapshot_v5, latest_snapshots),
            "proposal_learning_loop.v4_governed_work_loop_governance_recommendation_frontier_recursion_boundary_audit_v1": _artifact_reference(work_loop_execution_snapshot_v6, latest_snapshots),
            ...
            "memory_summary.v4_governed_work_loop_evidence_snapshot_v3": _artifact_reference(work_loop_evidence_snapshot_v3, latest_snapshots),
            "memory_summary.v4_governed_work_loop_evidence_snapshot_v4": _artifact_reference(work_loop_evidence_snapshot_v4, latest_snapshots),
            "memory_summary.v4_governed_work_loop_evidence_snapshot_v5": _artifact_reference(work_loop_evidence_snapshot_v5, latest_snapshots),
            "memory_summary.v4_governed_work_loop_evidence_snapshot_v6": _artifact_reference(work_loop_evidence_snapshot_v6, latest_snapshots),
        ...
        "governed_work_loop_candidate_screen_v7_summary": {
            "snapshot_identity_context": {
                "snapshot_template_name": "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v7",
                "proposal_id": str(proposal.get("proposal_id", "")),
                "current_work_loop_posture": primary_posture_class,
                "future_posture_review_gate_status": future_posture_review_gate_status,
                "current_branch_state": current_branch_state,
            ...
            "chain_state_reviewed": {
                ...
                "continuation_v3": dict(loop_chain_state.get("continuation_v3", {})),
                "continuation_v4": dict(loop_chain_state.get("continuation_v4", {})),
                "continuation_v5": dict(loop_chain_state.get("continuation_v5", {})),
                "continuation_v6": dict(loop_chain_state.get("continuation_v6", {})),
                "chain_classification": str(dict(work_loop_evidence_v6_summary.get("chain_distinct_value_assessment", {})).get("classification", "")),
                "unique_step_name_count": int(dict(work_loop_evidence_v6_summary.get("chain_distinct_value_assessment", {})).get("unique_step_name_count", 0) or 0),
                "successful_step_count": int(dict(work_loop_evidence_v6_summary.get("repeated_bounded_success_assessment", {})).get("successful_step_count", 0) or 0),
            },
            ...
            "top_candidate_rationale": {
                "reason": str(best_candidate.get("rationale", "")),
                "execution_adjacency": str(dict(best_candidate.get("screen_dimensions", {})).get("structural_vs_local_value", {}).get("execution_adjacency", "")),
                "structural_yield": str(dict(best_candidate.get("screen_dimensions", {})).get("structural_vs_local_value", {}).get("structural_yield", "")),
                "administrative_recursion_risk": str(dict(best_candidate.get("screen_dimensions", {})).get("administrative_recursion", {}).get("risk", "")),
                "diminishing_returns_assessment": diminishing_returns_classification,
                "circularity_risk_assessment": circularity_risk_classification,
            },
            "distinctness_assessment": {
                "classification": "materially_distinct_candidate_present" if bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("materially_distinct_from_chain", False)) else "absent",
                ...
                "top_candidate_distinct_from_continuation_v3": bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("distinct_from_continuation_v3", False)),
                "top_candidate_distinct_from_evidence_snapshot_v3": bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("distinct_from_evidence_snapshot_v3", False)),
                "top_candidate_distinct_from_continuation_v4": bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("distinct_from_continuation_v4", False)),
                "top_candidate_distinct_from_evidence_snapshot_v4": bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("distinct_from_evidence_snapshot_v4", False)),
                "top_candidate_distinct_from_continuation_v5": bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("distinct_from_continuation_v5", False)),
                "top_candidate_distinct_from_evidence_snapshot_v5": bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("distinct_from_evidence_snapshot_v5", False)),
                "top_candidate_distinct_from_continuation_v6": bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("distinct_from_continuation_v6", False)),
                "top_candidate_distinct_from_evidence_snapshot_v6": bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("distinct_from_evidence_snapshot_v6", False)),
            },
            "expected_evidence_yield_assessment": {
                "classification": "likely_adds_new_evidence" if bool(dict(best_candidate.get("screen_dimensions", {})).get("expected_evidence_yield", {}).get("likely_adds_new_evidence", False)) else "mostly_restates_prior_conclusions",
                "likely_adds_new_evidence": bool(dict(best_candidate.get("screen_dimensions", {})).get("expected_evidence_yield", {}).get("likely_adds_new_evidence", False)),
                "likely_restates_existing_governance_conclusions": not bool(dict(best_candidate.get("screen_dimensions", {})).get("expected_evidence_yield", {}).get("likely_adds_new_evidence", False)),
            },
            "structural_vs_recursive_value_assessment": {
                "classification": "execution_adjacent_structural_yield" if str(dict(best_candidate.get("screen_dimensions", {})).get("structural_vs_local_value", {}).get("classification", "")) == "execution_adjacent_structural_yield" else "mostly_administrative_recursion",
            ...
            "administrative_recursion_risk_assessment": {
                "classification": f"administrative_recursion_risk_{str(dict(best_candidate.get('screen_dimensions', {})).get('administrative_recursion', {}).get('risk', 'unknown'))}",
                "risk": str(dict(best_candidate.get("screen_dimensions", {})).get("administrative_recursion", {}).get("risk", "")),
            },
            "diminishing_returns_assessment": {
                "classification": diminishing_returns_classification,
                "frontier_nearing_diminishing_returns": frontier_nearing_diminishing_returns,
            },
            "circularity_risk_assessment": {
                "classification": circularity_risk_classification,
                "frontier_nearing_circularity": circularity_risk_not_low,
            },
            "posture_pressure_assessment": {
                "classification": "posture_pressure_absent" if not any([bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("hidden_capability_reopen_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("branch_mutation_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("retained_promotion_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("scope_expansion_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("posture_broadening_pressure", False))]) else "posture_pressure_present",
            ...
            "recommended_next_action": {
                "class": recommended_next_action_class,
                "template_name": next_template,
            },
            "continue_candidate_search_later_or_hold": {
                "hold_posture": True,
                "bounded_continuation_candidate_later_supported": ready_for_next_bounded_step_admission,
                "explicit_pause_because_candidate_frontier_is_weak": not ready_for_next_bounded_step_admission,
            ...
            "question_answers": {
                ...
                "credible_candidate_count": credible_candidate_count,
                "top_ranked_candidate_template_name": top_candidate_execution_template,
                "top_candidate_materially_distinct_from_full_reviewed_chain": bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("materially_distinct_from_chain", False)),
                "top_candidate_execution_adjacent_and_structurally_useful": str(dict(best_candidate.get("screen_dimensions", {})).get("structural_vs_local_value", {}).get("classification", "")) == "execution_adjacent_structural_yield",
                "top_candidate_likely_adds_new_evidence": bool(dict(best_candidate.get("screen_dimensions", {})).get("expected_evidence_yield", {}).get("likely_adds_new_evidence", False)),
                "hidden_pressure_toward_reopen_branch_promotion_scope_or_broadening": any([bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("hidden_capability_reopen_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("branch_mutation_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("retained_promotion_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("scope_expansion_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("posture_broadening_pressure", False))]),
                "frontier_nearing_diminishing_returns_or_circularity": frontier_nearing_diminishing_returns_or_circularity,
                "project_next_posture_decision": ("permit_another_bounded_continuation_candidate_later" if ready_for_next_bounded_step_admission else ("stop_continuation" if stop_continuation else "hold_posture")),
            ...
            "review_rollback_deprecation_trigger_status": dict(work_loop_evidence_v6_summary.get("review_rollback_deprecation_trigger_status", {})),
            ...
            "operator_readable_conclusion": (
                "One credible next bounded continuation candidate remains after screening the strengthened seven-step chain, and the frontier is still not nearing diminishing returns or circularity."
                if ready_for_next_bounded_step_admission
                else (
                    "A candidate still exists, but the frontier should hold posture because diminishing-return or circularity pressure is rising."
                    if credible_candidate_present
                    else "No credible next bounded continuation candidate remains after screening the strengthened seven-step chain."
                )
            ),
            ...
            "why_governance_remains_source_of_truth": {
                ...
                "reason": "candidate screening v7 is derived from directive, bucket, branch, self-structure, posture, direct-work evidence, continuation evidence, frontier-containment execution, frontier-stability execution, frontier-persistence execution, frontier-recursion execution, evidence v6, and recommendation artifacts rather than from execution code or prior success alone",
            },
        },
        "analytics_context": {
        ...
        "observability_gain": {
            "passed": True,
            "reason": "the current frontier after the strengthened seven-step chain now has an explicit v7 candidate inventory, credibility count, structural-yield assessment, diminishing-return/circularity read, and gate-closed posture judgment under governance",
            "artifact_paths": {
                "governed_work_loop_candidate_screen_v7_artifact": str(artifact_path),
                "self_structure_state_latest": str(SELF_STRUCTURE_STATE_PATH),
                "self_structure_ledger": str(SELF_STRUCTURE_LEDGER_PATH),
            },
        },
        "activation_analysis_usefulness": {
            "passed": True,
            "reason": "the v7 screen determines whether any further bounded continuation candidate still exists after the strengthened seven-step chain without assuming that prior success automatically authorizes more motion",
        },
        "ambiguity_reduction": {
            "passed": True,
            "score": 0.99,
            "reason": "the v7 screen explicitly distinguishes structural yield, administrative recursion, diminishing-return pressure, circularity risk, posture pressure, diversion, pause, and halt outcomes before any later admission work",
        },
        "safety_neutrality": {
            "passed": True,
            "scope": str(proposal.get("scope", "")),
            "reason": "the v7 screen is diagnostic-only; it widened no posture, reopened no capability, mutated no branch state, promoted nothing, and changed no live behavior",
        },
        "later_selection_usefulness": {
            "passed": True,
            "recommended_next_template": next_template,
            "reason": "one credible bounded candidate remains and can later move into a v7 continuation-admission review while posture stays narrow" if ready_for_next_bounded_step_admission else ("the frontier should now hold posture because diminishing-return or circularity pressure rises even though a candidate inventory still exists" if credible_candidate_present else "the frontier is weak enough that the correct outcome is to hold posture or stop continuation rather than advance to another admission step"),
        },
        "diagnostic_conclusions": {
            "governed_work_loop_candidate_screening_v7_in_place": True,
            "credible_candidate_present": credible_candidate_present,
            "materially_distinct_candidate_present": bool(dict(best_candidate.get("screen_dimensions", {})).get("distinctness_vs_reviewed_chain", {}).get("materially_distinct_from_chain", False)),
            ...
            "execution_adjacent_structural_yield": str(dict(best_candidate.get("screen_dimensions", {})).get("structural_vs_local_value", {}).get("classification", "")) == "execution_adjacent_structural_yield",
            ...
            "not_nearing_diminishing_returns": not frontier_nearing_diminishing_returns,
            "circularity_risk_low": not circularity_risk_not_low,
            "posture_pressure_absent": not any([bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("hidden_capability_reopen_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("branch_mutation_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("retained_promotion_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("scope_expansion_pressure", False)), bool(dict(best_candidate.get("screen_dimensions", {})).get("posture_pressure", {}).get("posture_broadening_pressure", False))]),
    ...
    return {
        ...
        "shadow_contract": "diagnostic_probe",
        "proposal_semantics": "diagnostic",
        "reason": "diagnostic shadow passed: the next round of governed work-loop candidates was screened after the strengthened seven-step chain under the narrow posture and a single strongest bounded next step was identified",
