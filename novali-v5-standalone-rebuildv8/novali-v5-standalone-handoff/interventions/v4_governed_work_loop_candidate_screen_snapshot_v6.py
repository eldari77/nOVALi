...
def _build_loop_candidate_examples_v6(
    *,
    ...
    return [
        {
            "loop_candidate_id": "loop_candidate_governance_recommendation_frontier_recursion_boundary_audit",
            "loop_candidate_name": "Governance recommendation-frontier recursion boundary audit",
            "loop_candidate_summary": "audit whether the recommendation frontier remains recursion-bounded, materially distinct, and structurally yielding after the successful frontier-persistence execution rather than collapsing into administrative recursion or pressure toward posture broadening",
            "proposed_execution_template": "proposal_learning_loop.v4_governed_work_loop_governance_recommendation_frontier_recursion_boundary_audit_v1",
            ...
            "expected_success_signal": "a bounded frontier-recursion artifact showing whether the current recommendation frontier stays recursion-bounded, structurally useful, and evidence-yielding across successive bounded executions without widening execution",
            ...
            "distinctness_basis": "tests recommendation-frontier recursion boundaries after frontier persistence rather than repeating state coherence, raw ledger consistency, recommendation-to-ledger alignment, frontier containment, frontier stability, frontier persistence, or evidence consolidation",
        ...
        {
            "loop_candidate_id": "loop_candidate_repeat_recommendation_frontier_persistence_boundary_without_recursion_signal",
            "loop_candidate_name": "Repeat recommendation-frontier persistence boundary audit with no recursion signal",
            "loop_candidate_summary": "restate the current persistence-bounded frontier without a new recursion-boundary question or a new bounded operational signal",
            ...
            "expected_success_signal": "another persistence-oriented pass that mostly rephrases current governance conclusions without a new bounded recursion signal",
            "touches_protected_surface": False,
            "touches_downstream_selected_set": False,
            "touches_plan_ownership": False,
            "touches_routing": False,
            "touches_branch_state": False,
            "unbounded_contextual_exploration": False,
            "distinctness_basis": "materially overlaps the frontier-persistence execution and evidence v5 while introducing no new frontier-facing bounded question",
            "distinct_from_direct_work": True,
        ...
        {
            "loop_candidate_id": "loop_candidate_high_consequence_governance_frontier_recursion_exception_support",
            "loop_candidate_name": "High-consequence governance frontier recursion exception support",
            "loop_candidate_summary": "perform a bounded but decision-critical frontier-recursion exception support task whose consequence profile requires explicit review before continuation",
            "proposed_execution_template": "",
            "directive_relevance": "high",
            "support_vs_drift": "support",
            "trusted_sources": ["local_artifacts:novali-v4/data"],
            ...
            "expected_incremental_value": "medium",
            "repeats_low_yield_narrow_shape": False,
            "expected_success_signal": "a bounded frontier-recursion exception-support output only if review clears the consequence profile",
            "touches_protected_surface": False,
            "touches_downstream_selected_set": False,
            "touches_plan_ownership": False,
            "touches_routing": False,
        ...
        {
            "loop_candidate_id": "loop_candidate_local_trace_parser_frontier_recursion_trace_extension",
            "loop_candidate_name": "Local trace parser frontier-recursion trace extension",
            "loop_candidate_summary": "extend the paused parser capability to a new frontier-recursion trace family inside the governed loop",
            "proposed_execution_template": "",
            "directive_relevance": "high",
            "support_vs_drift": "support",
            "trusted_sources": ["local_artifacts:novali-v4/data", "local_logs:logs"],
        ...
        {
            "loop_candidate_id": "loop_candidate_cross_artifact_recommendation_frontier_recursion_lineage_reconstruction",
            "loop_candidate_name": "Cross-artifact recommendation-frontier recursion lineage reconstruction",
        ...
        {
            "loop_candidate_id": "loop_candidate_broad_multi_path_recommendation_frontier_recursion_expansion_sweep",
            "loop_candidate_name": "Broad multi-path recommendation-frontier recursion expansion sweep",
...
def _next_path_for_loop_class_v4(class_name: str) -> dict[str, Any]:
    if class_name == "loop_continue_candidate":
        return {
            "next_template": "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v6",
    ...
    *,
    ...
    return {
        ...
        "distinct_bounded_next_step_rule": {
            ...
            "reason": (
                "the candidate adds a distinct bounded next-step signal beyond the current six-step chain, including frontier-containment, frontier-stability, frontier-persistence, and the v5 evidence layer"
...
def _screen_loop_candidate_v4(
    ...
    *,
    ...
    screened["loop_accounting_expectations"]["loop_identity_context"]["loop_iteration"] = "after_six_step_chain_evidence_v5"
...
def run_probe(cfg, proposal, *, rounds, seeds):
    ...
    work_loop_candidate_screen_snapshot_v5 = r._load_latest_diagnostic_artifact_by_template(
        "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v5"
    )
    work_loop_continuation_admission_snapshot_v5 = r._load_latest_diagnostic_artifact_by_template(
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_snapshot_v5,
            work_loop_continuation_admission_snapshot_v5,
        ...
        return {
            ...
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v6 requires the strengthened six-step chain, evidence v5, posture v1, v5 candidate screen, v5 continuation admission, direct-work evidence, and capability-use evidence artifacts",
            "observability_gain": {"passed": False, "reason": "missing prerequisite governed work-loop v6 candidate-screen artifacts"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite governed work-loop v6 candidate-screen artifacts"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite governed work-loop v6 candidate-screen artifacts"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot screen a sixth bounded continuation frontier without the full narrow-posture evidence chain"},
        }
    ...
    if not all([directive_state, bucket_state, self_structure_state, branch_registry]):
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v6 requires current directive, bucket, self-structure, and branch artifacts",
    ...
    if not governed_work_loop_policy or not governed_capability_use_policy or not governed_directive_work_selection_policy:
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v6 requires current work-loop, capability-use, and directive-work governance state",
    ...
    work_loop_candidate_screen_v5_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    work_loop_continuation_admission_v5_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    work_loop_execution_v4_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    work_loop_evidence_v3_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    work_loop_evidence_v4_artifact_path = _resolve_artifact_path_for_pattern(
        governed_work_loop_policy.get("last_prior_work_loop_evidence_artifact_path"),
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_v5_artifact_path,
            work_loop_continuation_admission_v5_artifact_path,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: one or more governed work-loop v6 reference artifact paths could not be resolved",
            "observability_gain": {"passed": False, "reason": "missing resolved artifact paths for work-loop screening v6"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing resolved artifact paths for work-loop screening v6"},
            "ambiguity_reduction": {"passed": False, "reason": "missing resolved artifact paths for work-loop screening v6"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
    ...
    work_loop_candidate_screen_v5_payload = _load_json_file(work_loop_candidate_screen_v5_artifact_path)
    work_loop_continuation_admission_v5_payload = _load_json_file(work_loop_continuation_admission_v5_artifact_path)
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_v5_payload,
            work_loop_continuation_admission_v5_payload,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v6 could not load one or more governing payloads",
            "observability_gain": {"passed": False, "reason": "missing prerequisite summary payloads for work-loop screening v6"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite summary payloads for work-loop screening v6"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite summary payloads for work-loop screening v6"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot screen the next frontier without the v5 evidence chain payloads"},
        }

    work_loop_policy_summary = dict(work_loop_policy_payload.get("governed_work_loop_policy_summary", {}))
    work_loop_candidate_screen_v5_summary = dict(
        work_loop_candidate_screen_v5_payload.get("governed_work_loop_candidate_screen_v5_summary", {})
    )
    work_loop_continuation_admission_v5_summary = dict(
        work_loop_continuation_admission_v5_payload.get("governed_work_loop_continuation_admission_v5_summary", {})
    )
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_v5_summary,
            work_loop_continuation_admission_v5_summary,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v6 could not load the governing summaries",
            "observability_gain": {"passed": False, "reason": "missing prerequisite work-loop v6 summaries"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite work-loop v6 summaries"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite work-loop v6 summaries"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
    ...
    future_posture_review_gate = dict(work_loop_evidence_v5_summary.get("gate_status", {}))
    loop_chain_state = dict(work_loop_evidence_v5_summary.get("chain_state_reviewed", {}))
    ready_for_candidate_screen_v6 = (
        ...
        and not bool(dict(work_loop_evidence_v5_summary.get("future_posture", {})).get("broader_execution_opened", True))
        and str(dict(work_loop_evidence_v5_summary.get("chain_distinct_value_assessment", {})).get("classification", "")) == "accumulating_distinct_value"
        and str(dict(work_loop_evidence_v5_summary.get("repeated_bounded_success_assessment", {})).get("classification", "")) == "repeated_bounded_success_strengthened"
        and str(dict(work_loop_evidence_v5_summary.get("posture_discipline_assessment", {})).get("classification", "")) == "posture_discipline_holding_cleanly"
        and str(dict(work_loop_evidence_v5_summary.get("posture_pressure_assessment", {})).get("classification", "")) == "posture_pressure_absent"
        and str(dict(work_loop_evidence_v5_summary.get("new_execution_signal_assessment", {})).get("classification", "")) == "materially_improved_evidence_picture"
        and str(future_posture_review_gate.get("gate_status", "")) == "defined_but_closed"
    )
    if not ready_for_candidate_screen_v6:
        return {
            "passed": False,
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: current state is not yet marked ready for governed work-loop candidate screening v6",
            "observability_gain": {"passed": False, "reason": "v6 candidate-frontier readiness is not yet established"},
            "activation_analysis_usefulness": {"passed": False, "reason": "v6 candidate-frontier readiness is not yet established"},
            "ambiguity_reduction": {"passed": False, "reason": "v6 candidate-frontier readiness is not yet established"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "the current six-step chain, posture, and evidence v5 gate status must all remain aligned before screening another bounded frontier"},
        }
    ...
    loop_continuation_future_posture = str(dict(work_loop_evidence_v5_summary.get("future_posture", {})).get("category", ""))
    ...
    screen_schema = {
        ...
        "schema_version": "governed_work_loop_candidate_screen_v6",
        "required_fields": [
            "loop_candidate_id",
            "loop_candidate_name",
    ...
    artifact_path = _diagnostic_artifact_dir() / f"memory_summary_v4_governed_work_loop_candidate_screen_snapshot_v6_{proposal['proposal_id']}.json"

    updated_self_structure_state = dict(self_structure_state)
    updated_work_loop_policy = dict(governed_work_loop_policy)
    updated_work_loop_policy["work_loop_candidate_screen_v6_schema"] = screen_schema
    updated_work_loop_policy["work_loop_candidate_screen_schema"] = screen_schema
    updated_work_loop_policy["last_prior_candidate_screen_artifact_path"] = str(work_loop_candidate_screen_v5_artifact_path)
    ...
    updated_work_loop_policy["last_candidate_screen_outcome"] = {
        "status": "credible_next_bounded_candidate_identified_v6" if credible_candidate_present else "candidate_frontier_weak_v6",
        ...
        "reason": (
            "one credible next bounded continuation candidate remains after screening"
    ...
    updated_current_state_summary.update(
        {
            "governed_work_loop_candidate_screening_v6_in_place": True,
            "latest_governed_work_loop_candidate_screen_outcome": (
                "credible_next_bounded_candidate_identified_v6" if credible_candidate_present else "candidate_frontier_weak_v6"
            ),
            ...
            "latest_governed_work_loop_continuation_readiness": (
                "ready_for_sixth_governed_work_loop_continuation_admission"
                if credible_candidate_present
    ...
    ledger_event = {
        "event_id": f"governed_work_loop_candidate_screen_snapshot_v6::{proposal['proposal_id']}",
        "timestamp": _now(),
        "event_type": "governed_work_loop_candidate_screen_snapshot_v6_materialized",
        ...
        "artifact_paths": {
            ...
            "governed_work_loop_candidate_screen_v5": str(work_loop_candidate_screen_v5_artifact_path),
            "governed_work_loop_continuation_admission_v5": str(work_loop_continuation_admission_v5_artifact_path),
            ...
            "governed_work_loop_candidate_screen_v6": str(artifact_path),
        },
    ...
    artifact_payload = {
        ...
        "template_name": "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v6",
        ...
        "comparison_references": {
            ...
            "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v5": _artifact_reference(work_loop_candidate_screen_snapshot_v5, latest_snapshots),
            "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v5": _artifact_reference(work_loop_continuation_admission_snapshot_v5, latest_snapshots),
        ...
        "governed_work_loop_candidate_screen_v6_summary": {
            "snapshot_identity_context": {
                "snapshot_template_name": "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v6",
                "proposal_id": str(proposal.get("proposal_id", "")),
                "current_work_loop_posture": primary_posture_class,
                "future_posture_review_gate_status": future_posture_review_gate_status,
                "current_branch_state": current_branch_state,
            ...
            "chain_state_reviewed": {
                ...
                "chain_classification": str(dict(work_loop_evidence_v5_summary.get("chain_distinct_value_assessment", {})).get("classification", "")),
                "unique_step_name_count": int(dict(work_loop_evidence_v5_summary.get("chain_distinct_value_assessment", {})).get("unique_step_name_count", 0) or 0),
                "successful_step_count": int(dict(work_loop_evidence_v5_summary.get("repeated_bounded_success_assessment", {})).get("successful_step_count", 0) or 0),
            },
            ...
            "expected_evidence_yield_assessment": {
                "classification": "likely_adds_new_evidence" if credible_candidate_present else "mostly_restates_prior_conclusions",
            ...
            "structural_vs_local_value_assessment": {
                "classification": "execution_adjacent_structural_yield" if credible_candidate_present else "mostly_administrative_recursion",
            ...
            "continue_candidate_search_later_or_hold": {
                "hold_posture": True,
                "bounded_continuation_candidate_later_supported": credible_candidate_present,
            ...
            "review_rollback_deprecation_trigger_status": dict(work_loop_evidence_v5_summary.get("review_rollback_deprecation_trigger_status", {})),
            ...
            "operator_readable_conclusion": (
                "One credible next bounded continuation candidate remains after screening the strengthened six-step chain."
                if credible_candidate_present
                else "No credible next bounded continuation candidate remains after screening the strengthened six-step chain."
            ),
            ...
            "why_governance_remains_source_of_truth": {
                ...
                "reason": "candidate screening v6 is derived from directive, bucket, branch, self-structure, posture, direct-work evidence, continuation evidence, frontier-containment execution, frontier-stability execution, frontier-persistence execution, evidence v5, and recommendation artifacts rather than from execution code or prior success alone",
            },
        },
        "analytics_context": {
        ...
        "observability_gain": {
            "passed": True,
            "reason": "the current frontier after the strengthened six-step chain now has an explicit v6 candidate inventory, credibility count, structural-yield assessment, and gate-closed posture judgment under governance",
            "artifact_paths": {
                "governed_work_loop_candidate_screen_v6_artifact": str(artifact_path),
                "self_structure_state_latest": str(SELF_STRUCTURE_STATE_PATH),
                "self_structure_ledger": str(SELF_STRUCTURE_LEDGER_PATH),
            },
        },
        "activation_analysis_usefulness": {
            "passed": True,
            "reason": "the v6 screen determines whether any further bounded continuation candidate still exists after the strengthened six-step chain without assuming that prior success automatically authorizes more motion",
        },
        "ambiguity_reduction": {
            "passed": True,
            "score": 0.99,
            "reason": "the v6 screen explicitly distinguishes structural yield, administrative recursion, posture pressure, diversion, pause, and halt outcomes before any later admission work",
        },
        "safety_neutrality": {
            "passed": True,
            "scope": str(proposal.get("scope", "")),
            "reason": "the v6 screen is diagnostic-only; it widened no posture, reopened no capability, mutated no branch state, promoted nothing, and changed no live behavior",
        },
        "later_selection_usefulness": {
            "passed": True,
            "recommended_next_template": next_template,
            "reason": "one credible bounded candidate remains and can later move into a v6 continuation-admission review while posture stays narrow" if credible_candidate_present else "the frontier is weak enough that the correct outcome is to hold posture rather than advance to another admission step",
        },
    ...
    return {
        ...
        "shadow_contract": "diagnostic_probe",
        "proposal_semantics": "diagnostic",
        "reason": "diagnostic shadow passed: the next round of governed work-loop candidates was screened after the strengthened six-step chain under the narrow posture and a single strongest bounded next step was identified",
