...
This is the primary operator-facing guide for the standalone `novali-v6` handoff package.

Branch-status note:

- this guide documents the frozen `novali-v5` reference/operator surface baseline
- active development has moved to `novali-v6`
- `novali-v4` remains historical reference context only
...
- `runtime_data/acceptance_evidence/`
  ...
  - canonical rc07 handoffs include the bundled image archive under `image/novali-v6-standalone.tar`
  - canonical rc07 handoffs also include a curated successor-improvement bundle under `runtime_data/acceptance_evidence/successor_improvement/`
- `samples/`
...
Trusted-source provider onboarding is now operator-visible on the browser home page:
