...
- image tag is `novali-v6-standalone:local`
...
.\standalone_docker\generate_directive_scaffold.ps1 `
  ...
  --clarified-intent-summary "Bootstrap novali-v6 under the canonical standalone operator flow and preserve artifact-backed governance authority before execution."
```
...
- set Docker image to `novali-v6-standalone:local`
