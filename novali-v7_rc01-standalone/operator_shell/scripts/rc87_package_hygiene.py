...
from operator_shell.external_adapter import resolve_rc87_artifact_root
...
FAKE_SEEDS = (
    ...
    _fake_seed("api", "key"),
    _fake_seed("cookie"),
    _fake_seed("observation", "secret"),
    _fake_seed("fixture", "payload", "secret"),
    _fake_seed("rollback", "secret"),
)
...
def _markdown_summary(summary: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            f"- Delta bytes vs rc86: {summary.get('delta_bytes', 0)}",
...
def run_package_hygiene(
    *,
    ...
    summary = {
        "schema_name": "novali_rc87_package_hygiene_summary_v1",
    ...
    artifact_root = resolve_rc87_artifact_root(ROOT)
