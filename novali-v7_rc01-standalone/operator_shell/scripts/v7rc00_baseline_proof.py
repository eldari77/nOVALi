...
ACTIVE_PACKAGE_NAME = "novali-v7_rc01-standalone"
...
def _package_paths(package_root: Path) -> dict[str, Path]:
    return {
        ...
        "v7_zip": package_root / "dist" / "novali-v7_rc01-standalone.zip",
        "v7_unpacked": package_root / "dist" / "novali-v7_rc01-standalone",
    }
