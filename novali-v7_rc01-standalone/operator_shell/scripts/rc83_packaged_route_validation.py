...
from operator_shell.observability.rc83 import resolve_rc83_artifact_root, write_summary_artifacts
...
def _markdown_summary(summary: dict[str, Any]) -> str:
    lines = [
        "# rc83 Packaged Route Validation",
        "",
...
def run_packaged_route_validation(
    *,
    ...
    summary = {
        "schema_name": "novali_rc83_packaged_route_validation_summary_v1",
...
def main() -> int:
    ...
    parser.add_argument(
        "--package-root",
        default=str(ROOT / "dist" / "novali-v6_rc83-standalone"),
    )
