...
PACKAGE_ROOT_NAME = "novali-v7_rc01-standalone"
...
def main() -> int:
    ...
    parser.add_argument("--zip-path", default=str(ROOT / "dist" / "novali-v7_rc01-standalone.zip"))
    parser.add_argument(
        "--baseline-zip-path",
    ...
    parser.add_argument(
        ...
        default=str(ROOT.parent / "novali-v6" / "dist" / "novali-v7_rc01-standalone.zip"),
    )
