...
- Public package: `novali-v7_rc02-standalone`
- Package mode: source-first local Docker/browser handoff
- Browser surface: `http://127.0.0.1:8787/shell`
- Image policy: build locally from `Dockerfile`; no prebuilt archive is bundled
