...
SUSPICIOUS_ENTRY_PATTERNS = (
    ...
    re.compile(r"(^|/)dist/novali-v7_", re.IGNORECASE),
)
ALLOWED_SPACE_ENGINEERS_MEMO_ENTRIES = {
    "novali-v6_rc88_1-standalone/planning/space_engineers/",
    "novali-v6_rc88_1-standalone/planning/space_engineers/rc88_transition_decision_memo.md",
}
...
def _markdown_summary(summary: dict[str, Any]) -> str:
    return "\n".join(
        [
            "# rc88.1 Package Hygiene Summary",
            "",
            ...
            f"- Delta bytes vs rc88: {summary.get('delta_bytes', 0)}",
...
def run_package_hygiene(*, zip_path: Path, baseline_zip_path: Path | None = None) -> dict[str, Any]:
    ...
    with zipfile.ZipFile(zip_path) as package:
        ...
        for info in infos:
            is_allowed_space_engineers_memo_entry = (
                info.filename in ALLOWED_SPACE_ENGINEERS_MEMO_ENTRIES
            )
            if (
    ...
    summary = {
        "schema_name": "novali_rc88_1_package_hygiene_summary_v1",
