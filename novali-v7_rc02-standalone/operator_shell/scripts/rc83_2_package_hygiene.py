...
def _markdown_summary(summary: dict[str, Any]) -> str:
    return "\n".join(
        [
            "# rc83.2 Package Hygiene Summary",
            "",
            ...
            f"- Delta bytes vs rc83.1: {summary.get('delta_bytes', 0)}",
...
def run_package_hygiene(
    *,
    ...
    summary = {
        "schema_name": "novali_rc83_2_package_hygiene_summary_v1",
    ...
    artifact_root = resolve_rc83_2_artifact_root(ROOT)
