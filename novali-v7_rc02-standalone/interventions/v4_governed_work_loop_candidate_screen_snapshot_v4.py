...
def _build_loop_candidate_examples_v4(
    *,
    ...
    return [
        {
            "loop_candidate_id": "loop_candidate_governance_recommendation_frontier_stability_delta_audit",
            "loop_candidate_name": "Governance recommendation-frontier stability delta audit",
            "loop_candidate_summary": "audit whether the recommendation frontier remains stable, bounded, and structurally informative after the successful frontier-containment execution rather than slipping into weak repetition or pressure toward broadening",
            "proposed_execution_template": "proposal_learning_loop.v4_governed_work_loop_governance_recommendation_frontier_stability_delta_audit_v1",
            ...
            "expected_success_signal": "a bounded frontier-stability artifact showing whether the current recommendation frontier remains structurally stable, bounded, and evidence-yielding without widening execution",
            ...
            "distinctness_basis": "tests frontier stability after containment rather than repeating state coherence, raw ledger consistency, recommendation-to-ledger alignment, frontier containment, or evidence consolidation",
        ...
        {
            "loop_candidate_id": "loop_candidate_repeat_recommendation_frontier_containment_without_stability_delta",
            "loop_candidate_name": "Repeat recommendation-frontier containment audit with no stability delta",
            "loop_candidate_summary": "restate the current contained frontier without a new stability signal or a new bounded operational question",
            ...
            "expected_success_signal": "another containment-oriented pass that mostly rephrases current governance conclusions without a new bounded stability signal",
            "touches_protected_surface": False,
            "touches_downstream_selected_set": False,
            "touches_plan_ownership": False,
            "touches_routing": False,
            "touches_branch_state": False,
            "unbounded_contextual_exploration": False,
            "distinctness_basis": "materially overlaps the frontier-containment execution and evidence v3 while introducing no new frontier-facing bounded question",
            "distinct_from_direct_work": True,
        ...
        {
            "loop_candidate_id": "loop_candidate_high_consequence_governance_frontier_stability_exception_support",
            "loop_candidate_name": "High-consequence governance frontier stability exception support",
            "loop_candidate_summary": "perform a bounded but decision-critical frontier-stability exception support task whose consequence profile requires explicit review before continuation",
            "proposed_execution_template": "",
            "directive_relevance": "high",
            "support_vs_drift": "support",
            "trusted_sources": ["local_artifacts:novali-v4/data"],
            ...
            "expected_incremental_value": "medium",
            "repeats_low_yield_narrow_shape": False,
            "expected_success_signal": "a bounded frontier-stability exception-support output only if review clears the consequence profile",
            "touches_protected_surface": False,
            "touches_downstream_selected_set": False,
            "touches_plan_ownership": False,
            "touches_routing": False,
        ...
        {
            "loop_candidate_id": "loop_candidate_local_trace_parser_frontier_stability_trace_extension",
            "loop_candidate_name": "Local trace parser frontier-stability trace extension",
            "loop_candidate_summary": "extend the paused parser capability to a new frontier-stability trace family inside the governed loop",
            "proposed_execution_template": "",
            "directive_relevance": "high",
            "support_vs_drift": "support",
            "trusted_sources": ["local_artifacts:novali-v4/data", "local_logs:logs"],
        ...
        {
            "loop_candidate_id": "loop_candidate_cross_artifact_recommendation_frontier_lineage_reconstruction",
            "loop_candidate_name": "Cross-artifact recommendation-frontier lineage reconstruction",
        ...
        {
            "loop_candidate_id": "loop_candidate_broad_multi_path_recommendation_frontier_expansion_sweep",
            "loop_candidate_name": "Broad multi-path recommendation-frontier expansion sweep",
...
def _next_path_for_loop_class_v4(class_name: str) -> dict[str, Any]:
    if class_name == "loop_continue_candidate":
        return {
            "next_template": "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v4",
            "path_type": "work_loop_continuation_admission",
            "reason": "the strongest remaining bounded candidate should advance into a fourth governed work-loop continuation admission gate later while the current narrow posture remains unchanged",
        }
    ...
    *,
    ...
    return {
        ...
        "distinct_bounded_next_step_rule": {
            ...
            "reason": (
                "the candidate adds a distinct bounded next-step signal beyond the current four-step chain, the frontier-containment execution, and the v3 evidence layer"
...
def _screen_loop_candidate_v4(
    ...
    *,
    ...
    screened["loop_accounting_expectations"]["loop_identity_context"]["loop_iteration"] = "after_four_step_chain_evidence_v3"
...
def run_probe(cfg, proposal, *, rounds, seeds):
    ...
    work_loop_candidate_screen_snapshot_v3 = r._load_latest_diagnostic_artifact_by_template(
        "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v3"
    )
    work_loop_continuation_admission_snapshot_v3 = r._load_latest_diagnostic_artifact_by_template(
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_snapshot_v3,
            work_loop_continuation_admission_snapshot_v3,
        ...
        return {
            ...
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v4 requires the strengthened four-step chain, evidence v3, posture v1, v3 candidate screen, v3 continuation admission, direct-work evidence, and capability-use evidence artifacts",
            "observability_gain": {"passed": False, "reason": "missing prerequisite governed work-loop v4 candidate-screen artifacts"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite governed work-loop v4 candidate-screen artifacts"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite governed work-loop v4 candidate-screen artifacts"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot screen a fifth bounded continuation frontier without the full narrow-posture evidence chain"},
        }
    ...
    work_loop_candidate_screen_v3_artifact_path = _resolve_artifact_path(
        governed_work_loop_policy.get("last_candidate_screen_artifact_path"),
        "memory_summary_v4_governed_work_loop_candidate_screen_snapshot_v3_*.json",
    )
    work_loop_continuation_admission_v3_artifact_path = _resolve_artifact_path(
        governed_work_loop_policy.get("last_work_loop_continuation_admission_artifact_path"),
        "memory_summary_v4_governed_work_loop_continuation_admission_snapshot_v3_*.json",
    )
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_v3_artifact_path,
            work_loop_continuation_admission_v3_artifact_path,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: one or more governed work-loop v4 reference artifact paths could not be resolved",
            "observability_gain": {"passed": False, "reason": "missing resolved artifact paths for work-loop screening v4"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing resolved artifact paths for work-loop screening v4"},
            "ambiguity_reduction": {"passed": False, "reason": "missing resolved artifact paths for work-loop screening v4"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
    ...
    work_loop_candidate_screen_v3_payload = _load_json_file(work_loop_candidate_screen_v3_artifact_path)
    work_loop_continuation_admission_v3_payload = _load_json_file(work_loop_continuation_admission_v3_artifact_path)
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_v3_payload,
            work_loop_continuation_admission_v3_payload,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v4 could not load one or more governing payloads",
            "observability_gain": {"passed": False, "reason": "missing prerequisite summary payloads for work-loop screening v4"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite summary payloads for work-loop screening v4"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite summary payloads for work-loop screening v4"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot screen the next frontier without the v3 evidence chain payloads"},
        }

    work_loop_policy_summary = dict(work_loop_policy_payload.get("governed_work_loop_policy_summary", {}))
    work_loop_candidate_screen_v3_summary = dict(
        work_loop_candidate_screen_v3_payload.get("governed_work_loop_candidate_screen_v3_summary", {})
    )
    work_loop_continuation_admission_v3_summary = dict(
        work_loop_continuation_admission_v3_payload.get("governed_work_loop_continuation_admission_v3_summary", {})
    )
    ...
    if not all(
        [
            ...
            work_loop_candidate_screen_v3_summary,
            work_loop_continuation_admission_v3_summary,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: governed work-loop candidate screening v4 could not load the governing summaries",
            "observability_gain": {"passed": False, "reason": "missing prerequisite work-loop v4 summaries"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite work-loop v4 summaries"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite work-loop v4 summaries"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
    ...
    future_posture_review_gate = dict(work_loop_evidence_v3_summary.get("gate_status", {}))
    loop_chain_state = dict(work_loop_evidence_v3_summary.get("chain_state_reviewed", {}))
    ready_for_candidate_screen_v4 = (
        ...
        and not bool(dict(work_loop_evidence_v3_summary.get("future_posture", {})).get("broader_execution_opened", True))
        and str(dict(work_loop_evidence_v3_summary.get("chain_distinct_value_assessment", {})).get("classification", "")) == "accumulating_distinct_value"
        and str(dict(work_loop_evidence_v3_summary.get("repeated_bounded_success_assessment", {})).get("classification", "")) == "repeated_bounded_success_strengthened"
        and str(dict(work_loop_evidence_v3_summary.get("posture_discipline_assessment", {})).get("classification", "")) == "posture_discipline_holding_cleanly"
        and str(dict(work_loop_evidence_v3_summary.get("posture_pressure_assessment", {})).get("classification", "")) == "posture_pressure_absent"
        and str(dict(work_loop_evidence_v3_summary.get("new_execution_signal_assessment", {})).get("classification", "")) == "materially_improved_evidence_picture"
        and str(future_posture_review_gate.get("gate_status", "")) == "defined_but_closed"
    )
    if not ready_for_candidate_screen_v4:
        return {
            "passed": False,
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: current state is not yet marked ready for governed work-loop candidate screening v4",
            "observability_gain": {"passed": False, "reason": "v4 candidate-frontier readiness is not yet established"},
            "activation_analysis_usefulness": {"passed": False, "reason": "v4 candidate-frontier readiness is not yet established"},
            "ambiguity_reduction": {"passed": False, "reason": "v4 candidate-frontier readiness is not yet established"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "the current four-step chain, posture, and evidence v3 gate status must all remain aligned before screening another bounded frontier"},
        }
    ...
    loop_continuation_future_posture = str(dict(work_loop_evidence_v3_summary.get("future_posture", {})).get("category", ""))
    ...
    screen_schema = {
        ...
        "schema_version": "governed_work_loop_candidate_screen_v4",
        "required_fields": [
            "loop_candidate_id",
            "loop_candidate_name",
    ...
    loop_candidates = _build_loop_candidate_examples_v4(
    ...
    artifact_path = _diagnostic_artifact_dir() / f"memory_summary_v4_governed_work_loop_candidate_screen_snapshot_v4_{proposal['proposal_id']}.json"

    updated_self_structure_state = dict(self_structure_state)
    updated_work_loop_policy = dict(governed_work_loop_policy)
    updated_work_loop_policy["work_loop_candidate_screen_v4_schema"] = screen_schema
    updated_work_loop_policy["work_loop_candidate_screen_schema"] = screen_schema
    updated_work_loop_policy["last_prior_candidate_screen_artifact_path"] = str(work_loop_candidate_screen_v3_artifact_path)
    ...
    updated_work_loop_policy["last_candidate_screen_outcome"] = {
        "status": "credible_next_bounded_candidate_identified_v4" if credible_candidate_present else "candidate_frontier_weak_v4",
    ...
    updated_current_state_summary.update(
        {
            "governed_work_loop_candidate_screening_v4_in_place": True,
            "latest_governed_work_loop_candidate_screen_outcome": (
                "credible_next_bounded_candidate_identified_v4" if credible_candidate_present else "candidate_frontier_weak_v4"
            ),
            ...
            "latest_governed_work_loop_continuation_readiness": (
                "ready_for_fourth_governed_work_loop_continuation_admission"
                if credible_candidate_present
    ...
    ledger_event = {
        "event_id": f"governed_work_loop_candidate_screen_snapshot_v4::{proposal['proposal_id']}",
        "timestamp": _now(),
        "event_type": "governed_work_loop_candidate_screen_snapshot_v4_materialized",
        ...
        "artifact_paths": {
            ...
            "governed_work_loop_candidate_screen_v3": str(work_loop_candidate_screen_v3_artifact_path),
            "governed_work_loop_continuation_admission_v3": str(work_loop_continuation_admission_v3_artifact_path),
            ...
            "governed_work_loop_candidate_screen_v4": str(artifact_path),
        },
    ...
    artifact_payload = {
        ...
        "template_name": "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v4",
        ...
        "comparison_references": {
            ...
            "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v3": _artifact_reference(work_loop_candidate_screen_snapshot_v3, latest_snapshots),
            "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v3": _artifact_reference(work_loop_continuation_admission_snapshot_v3, latest_snapshots),
        ...
        "governed_work_loop_candidate_screen_v4_summary": {
            "snapshot_identity_context": {
                "snapshot_template_name": "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v4",
                "proposal_id": str(proposal.get("proposal_id", "")),
                "current_work_loop_posture": primary_posture_class,
                "future_posture_review_gate_status": future_posture_review_gate_status,
                "current_branch_state": current_branch_state,
            ...
            "chain_state_reviewed": {
                ...
                "chain_classification": str(dict(work_loop_evidence_v3_summary.get("chain_distinct_value_assessment", {})).get("classification", "")),
                "unique_step_name_count": int(dict(work_loop_evidence_v3_summary.get("chain_distinct_value_assessment", {})).get("unique_step_name_count", 0) or 0),
                "successful_step_count": int(dict(work_loop_evidence_v3_summary.get("repeated_bounded_success_assessment", {})).get("successful_step_count", 0) or 0),
            },
            ...
            "review_rollback_deprecation_trigger_status": dict(work_loop_evidence_v3_summary.get("review_rollback_deprecation_trigger_status", {})),
            ...
            "operator_readable_conclusion": (
                "One credible next bounded continuation candidate remains after screening the strengthened four-step chain."
                if credible_candidate_present
                else "No credible next bounded continuation candidate remains after screening the strengthened four-step chain."
            ),
            ...
            "why_governance_remains_source_of_truth": {
                ...
                "reason": "candidate screening v4 is derived from directive, bucket, branch, self-structure, posture, direct-work evidence, continuation evidence, frontier-containment evidence, and recommendation artifacts rather than from execution code or prior success alone",
            },
        },
        "analytics_context": {
        ...
        "observability_gain": {
            "passed": True,
            "reason": "the current frontier after the strengthened four-step chain now has an explicit v4 candidate inventory, credibility count, structural-yield assessment, and gate-closed posture judgment under governance",
            "artifact_paths": {
                "governed_work_loop_candidate_screen_v4_artifact": str(artifact_path),
                "self_structure_state_latest": str(SELF_STRUCTURE_STATE_PATH),
                "self_structure_ledger": str(SELF_STRUCTURE_LEDGER_PATH),
            },
        },
        "activation_analysis_usefulness": {
            "passed": True,
            "reason": "the v4 screen determines whether any further bounded continuation candidate still exists after the strengthened four-step chain without assuming that prior success automatically authorizes more motion",
        },
        "ambiguity_reduction": {
            "passed": True,
            "score": 0.99,
            "reason": "the v4 screen explicitly distinguishes structural yield, administrative recursion, posture pressure, diversion, pause, and halt outcomes before any later admission work",
        },
        "safety_neutrality": {
            "passed": True,
            "scope": str(proposal.get("scope", "")),
            "reason": "the v4 screen is diagnostic-only; it widened no posture, reopened no capability, mutated no branch state, promoted nothing, and changed no live behavior",
        },
        "later_selection_usefulness": {
            "passed": True,
            "recommended_next_template": next_template,
            "reason": "one credible bounded candidate remains and can later move into a v4 continuation-admission review while posture stays narrow" if credible_candidate_present else "the frontier is weak enough that the correct outcome is to hold posture rather than advance to another admission step",
        },
