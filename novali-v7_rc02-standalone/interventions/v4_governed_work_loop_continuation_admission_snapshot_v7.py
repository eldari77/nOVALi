...
from .v4_governed_work_loop_candidate_screen_snapshot_v7 import (
    ...
    _screen_loop_candidate_v4 as _screen_loop_candidate_v7,
)
...
def run_probe(cfg, proposal, *, rounds, seeds):
    ...
    candidate_screen_snapshot_v7 = r._load_latest_diagnostic_artifact_by_template(
    ...
    evidence_snapshot_v6 = r._load_latest_diagnostic_artifact_by_template(
        "memory_summary.v4_governed_work_loop_evidence_snapshot_v6"
    )
    continuation_admission_snapshot_v6 = r._load_latest_diagnostic_artifact_by_template(
    ...
    continuation_execution_v6 = r._load_latest_diagnostic_artifact_by_template(
    ...
    if not all(
        [
            ...
            evidence_snapshot_v6,
            continuation_admission_snapshot_v6,
        ...
        return {
            ...
            "reason": "diagnostic shadow failed: continuation admission v7 requires the current governed work-loop artifact chain",
            "observability_gain": {"passed": False, "reason": "missing prerequisite continuation-admission v7 artifacts"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite continuation-admission v7 artifacts"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite continuation-admission v7 artifacts"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot decide v7 admission without the local governance chain"},
        }
    ...
    if not all([directive_state, bucket_state, self_structure_state, branch_registry, recommendations]):
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: continuation admission v7 requires current directive, bucket, self-structure, branch, and recommendation state",
            ...
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot decide v7 admission without durable governance state"},
        }
    ...
    candidate_screen_v7_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    evidence_v3_artifact_path = _resolve_artifact_path(
        None,
        "memory_summary_v4_governed_work_loop_evidence_snapshot_v3_*.json",
    )
    evidence_v4_artifact_path = _resolve_artifact_path(
        None,
    ...
    evidence_v6_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    continuation_admission_v6_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    execution_v6_artifact_path = _resolve_artifact_path_for_pattern(
    ...
    if not all(
        [
            ...
            candidate_screen_v7_artifact_path,
            ...
            evidence_v6_artifact_path,
            continuation_admission_v6_artifact_path,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: continuation admission v7 could not resolve one or more governing artifact paths",
            "observability_gain": {"passed": False, "reason": "missing resolved continuation-admission v7 artifact paths"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing resolved continuation-admission v7 artifact paths"},
            "ambiguity_reduction": {"passed": False, "reason": "missing resolved continuation-admission v7 artifact paths"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot make a bounded v7 admission decision without the resolved local artifact chain"},
        }
    ...
    candidate_screen_v7_summary = _summary_from_path(
        candidate_screen_v7_artifact_path, "governed_work_loop_candidate_screen_v7_summary"
    )
    ...
    evidence_v6_summary = _summary_from_path(evidence_v6_artifact_path, "governed_work_loop_evidence_v6_summary")
    continuation_admission_v6_summary = _summary_from_path(
        continuation_admission_v6_artifact_path, "governed_work_loop_continuation_admission_v6_summary"
    )
    ...
    if not all(
        [
            ...
            evidence_v5_summary,
            evidence_v6_summary,
            continuation_admission_v6_summary,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: continuation admission v7 could not load the governing summaries",
            "observability_gain": {"passed": False, "reason": "missing continuation-admission v7 summaries"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing continuation-admission v7 summaries"},
            "ambiguity_reduction": {"passed": False, "reason": "missing continuation-admission v7 summaries"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot decide v7 admission without the governing summaries"},
        }
    ...
    candidate_name = str(
        dict(candidate_screen_v7_summary.get("top_ranked_candidate", {})).get("loop_candidate_name", "")
    ...
    if not candidate_record:
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: the surviving v7 candidate could not be reconstructed",
            "observability_gain": {"passed": False, "reason": "missing reconstructed v7 candidate"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing reconstructed v7 candidate"},
            "ambiguity_reduction": {"passed": False, "reason": "missing reconstructed v7 candidate"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot make a bounded decision without the surviving v7 candidate"},
        }
    ...
    screen_diminishing_returns = dict(candidate_screen_v7_summary.get("diminishing_returns_assessment", {}))
    evidence_circularity_risk = dict(evidence_v6_summary.get("circularity_risk_assessment", {}))
    screen_circularity_risk = dict(candidate_screen_v7_summary.get("circularity_risk_assessment", {}))
    evidence_posture_discipline = dict(evidence_v6_summary.get("posture_discipline_assessment", {}))
    evidence_posture_pressure = dict(evidence_v6_summary.get("posture_pressure_assessment", {}))
    evidence_repeated_success = dict(evidence_v6_summary.get("repeated_bounded_success_assessment", {}))
    future_posture = dict(evidence_v6_summary.get("future_posture", {}))

    evidence_diminishing_returns_class = str(evidence_diminishing_returns.get("classification", ""))
    screen_diminishing_returns_class = str(screen_diminishing_returns.get("classification", ""))
    evidence_circularity_class = str(evidence_circularity_risk.get("classification", ""))
    screen_circularity_class = str(screen_circularity_risk.get("classification", ""))
    effective_diminishing_returns_class = (
        "not_nearing_diminishing_returns"
        if evidence_diminishing_returns_class == "not_nearing_diminishing_returns"
        and screen_diminishing_returns_class == "not_nearing_diminishing_returns"
        else "nearing_diminishing_returns"
    )
    if "high" in {evidence_circularity_class, screen_circularity_class}:
        effective_circularity_class = "circularity_risk_high"
    elif "medium" in {evidence_circularity_class, screen_circularity_class}:
        effective_circularity_class = "circularity_risk_medium"
    else:
        effective_circularity_class = "circularity_risk_low"

    current_screening_ready = bool(current_state_summary.get("governed_work_loop_candidate_screening_v7_in_place", False)) or (
        str(current_state_summary.get("latest_governed_work_loop_candidate_screen_outcome", ""))
        == "credible_next_bounded_candidate_identified_v7"
    )
    top_ranked_candidate = dict(candidate_screen_v7_summary.get("top_ranked_candidate", {}))
    expected_evidence_yield_class = str(
        dict(candidate_screen_v7_summary.get("expected_evidence_yield_assessment", {})).get("classification", "")
    )
    candidate_template = str(dict(candidate_record.get("candidate_quality_flags", {})).get("proposed_execution_template", ""))

    admission_checks = {
        "single_surviving_candidate_confirmed": _check(
            int(candidate_screen_v7_summary.get("credible_candidate_count", 0) or 0) == 1,
            "the v7 candidate screen must leave exactly one credible bounded candidate",
        ),
        ...
        "candidate_matches_v7_top_rank": _check(
            str(candidate_record.get("loop_candidate_name", "")) == str(top_ranked_candidate.get("loop_candidate_name", "")),
            "the admitted candidate must match the top-ranked v7 candidate selected by governance",
        ),
        "materially_distinct_from_reviewed_chain": _check(
            bool(distinctness.get("materially_distinct_from_chain", False)),
            "the candidate must stay materially distinct from direct work, continuation v1, continuation v2, continuation v3, continuation v4, continuation v5, continuation v6, and evidence snapshots v2 through v6",
        ),
        "likely_adds_new_evidence": _check(
            expected_evidence_yield_class == "likely_adds_new_evidence",
        ...
        "execution_adjacent_structural_yield": _check(
            ...
            "the candidate must remain execution-adjacent and structurally useful rather than administratively recursive",
        ),
        ...
        "diminishing_returns_not_nearing": _check(
            effective_diminishing_returns_class == "not_nearing_diminishing_returns",
            "the candidate must still clear the v6 checkpoint concern that the loop is nearing diminishing returns",
        ),
        "circularity_risk_low": _check(
            effective_circularity_class == "circularity_risk_low",
            "the candidate must still clear the v6 checkpoint concern that the frontier is drifting toward circularity",
        ),
        "posture_pressure_absent_and_no_circularity_drift_pressure": _check(
            (
                str(posture_pressure.get("classification", "")) == "posture_pressure_absent"
                or str(posture_pressure.get("pressure", "")) == "absent"
            )
            and str(evidence_posture_pressure.get("classification", "")) == "posture_pressure_absent",
            "the candidate must not create hidden pressure toward capability reopening, branch mutation, retained promotion, scope expansion, posture broadening, or circularity drift",
        ),
        "narrow_posture_and_gate_closed": _check(
            ...
            and bool(future_posture.get("hold_narrow_posture_unchanged", False)),
        ...
        "repeated_bounded_success_and_clean_discipline": _check(
            str(evidence_repeated_success.get("classification", "")) == "repeated_bounded_success_strengthened"
            and str(evidence_posture_discipline.get("classification", "")) == "posture_discipline_holding_cleanly"
            and str(evidence_posture_pressure.get("classification", "")) == "posture_pressure_absent",
            "the admission must build on repeated bounded success with posture discipline still holding cleanly and hidden development pressure absent",
        ),
        "state_readiness_and_routing_guard": _check(
            current_screening_ready
            and str(current_state_summary.get("latest_governed_work_loop_continuation_readiness", ""))
            == "ready_for_seventh_governed_work_loop_continuation_admission"
            and str(dict(candidate_screen_v7_summary.get("recommended_next_action", {})).get("template_name", ""))
            == "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v7"
            and str(current_state_summary.get("latest_governed_work_loop_best_candidate_template", "")) == candidate_template
            and bool(current_state_summary.get("routing_deferred", False))
            and bool(current_state_summary.get("plan_non_owning", False)),
            "state must explicitly mark the seventh continuation-admission gate as ready while routing stays deferred and plan_ stays non-owning",
        ),
    ...
    admission_status = "admissible_for_governed_loop_continuation_v7" if all_checks_passed else "not_admissible_now"
    admission_rationale = (
        "the candidate is the single surviving bounded continuation option, materially distinct from the full reviewed chain, still expected to add new evidence, execution-adjacent, structurally useful, low-recursion, and still clears the v6 checkpoint concerns around diminishing returns and circularity under a still-closed gate"
    ...
    checkpoint_clearance_assessment = {
        "clears_checkpoint_strongly_enough_for_execution": all_checks_passed
        and effective_diminishing_returns_class == "not_nearing_diminishing_returns"
        and effective_circularity_class == "circularity_risk_low",
        "diminishing_returns_assessment": effective_diminishing_returns_class,
        "circularity_risk_assessment": effective_circularity_class,
    }

    continuation_envelope = {
        "work_loop_posture": "shadow_only_loop_continuation_v7",
        "allowed_scope": [
            "bounded recommendation-frontier circularity boundary audit only",
    ...
    artifact_path = _diagnostic_artifact_dir() / f"memory_summary_v4_governed_work_loop_continuation_admission_snapshot_v7_{proposal['proposal_id']}.json"

    updated_self_structure_state = dict(self_structure_state)
    updated_work_loop_policy = dict(governed_work_loop_policy)
    updated_work_loop_policy["work_loop_continuation_admission_v7_schema"] = {
        "schema_name": "GovernedWorkLoopContinuationAdmission",
        "schema_version": "governed_work_loop_continuation_admission_v7",
    ...
    updated_work_loop_policy["last_work_loop_continuation_admission_candidate"] = {
        ...
        "proposed_execution_template": candidate_template,
    }
    ...
    _append_jsonl(
        SELF_STRUCTURE_LEDGER_PATH,
        {
            "event_id": f"governed_work_loop_continuation_admission_snapshot_v7::{proposal['proposal_id']}",
            "timestamp": _now(),
            "event_type": "governed_work_loop_continuation_admission_snapshot_v7_materialized",
            ...
            "paused_capability_lines_reopened": False,
            "artifact_paths": {
                "governed_work_loop_continuation_admission_v7": str(artifact_path),
                "governed_work_loop_candidate_screen_v7": str(candidate_screen_v7_artifact_path),
                "governed_work_loop_evidence_v6": str(evidence_v6_artifact_path),
            },
    ...
    review_rollback_deprecation_trigger_status = dict(
        evidence_v6_summary.get("review_rollback_deprecation_trigger_status", {})
    ) or {
        "review_trigger_status": {
            "criticality": False,
            "overlap": False,
            "scope_expansion": False,
            "hidden_development_pressure": False,
        },
        ...
        "deprecation_trigger_status": {
            "directive_relevance_drop": False,
            "distinct_value_disappears": False,
        },
    }

    artifact_payload = {
        "proposal_id": str(proposal.get("proposal_id")),
        "template_name": "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v7",
        "branch_context": {
        ...
        "comparison_references": {
            ...
            "memory_summary.v4_governed_work_loop_candidate_screen_snapshot_v7": _artifact_reference(candidate_screen_snapshot_v7, latest_snapshots),
            ...
            "memory_summary.v4_governed_work_loop_evidence_snapshot_v6": _artifact_reference(evidence_snapshot_v6, latest_snapshots),
            "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v6": _artifact_reference(continuation_admission_snapshot_v6, latest_snapshots),
            ...
            "proposal_learning_loop.v4_governed_work_loop_governance_recommendation_frontier_recursion_boundary_audit_v1": _artifact_reference(continuation_execution_v6, latest_snapshots),
        ...
        "governed_work_loop_continuation_admission_v7_summary": {
            "snapshot_identity_context": {
                "snapshot_template_name": "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v7",
                "proposal_id": str(proposal.get("proposal_id", "")),
            ...
            "evidence_inputs_used": {
                ...
                "candidate_screen_snapshot_v7": str(candidate_screen_v7_artifact_path),
                ...
                "evidence_snapshot_v6": str(evidence_v6_artifact_path),
                "continuation_admission_v6": str(continuation_admission_v6_artifact_path),
                ...
                "continuation_execution_v6": str(execution_v6_artifact_path),
            ...
            "expected_evidence_yield_assessment": {
                "classification": "likely_adds_new_evidence" if expected_evidence_yield_class == "likely_adds_new_evidence" else "mostly_restates_prior_conclusions",
                "likely_adds_new_evidence": expected_evidence_yield_class == "likely_adds_new_evidence",
                "likely_restates_prior_conclusions": expected_evidence_yield_class != "likely_adds_new_evidence",
            },
            "diminishing_returns_assessment": {
                "classification": effective_diminishing_returns_class,
                "evidence_snapshot_v6_classification": evidence_diminishing_returns_class,
                "candidate_screen_v7_classification": screen_diminishing_returns_class,
            },
            "circularity_risk_assessment": {
                "classification": effective_circularity_class,
                "evidence_snapshot_v6_classification": evidence_circularity_class,
                "candidate_screen_v7_classification": screen_circularity_class,
            },
            "checkpoint_clearance_assessment": checkpoint_clearance_assessment,
            ...
            "review_rollback_deprecation_trigger_status": review_rollback_deprecation_trigger_status,
            "envelope_compliance_summary": {
                "network_mode": "none",
                "write_root_compliance": bool(write_root_report.get("passed", False)),
            ...
            "concise_operator_readable_conclusion": (
                "The surviving frontier-circularity-boundary candidate is admissible now under the current narrow governed envelope and still clears the diminishing-returns and circularity checkpoint strongly enough for execution."
                if all_checks_passed
                else "The surviving frontier-circularity-boundary candidate is not admissible now under the current narrow governed envelope."
            ),
            ...
            "why_governance_remains_source_of_truth": {
                ...
                "reason": "continuation admission v7 is derived from directive, bucket, branch, self-structure, candidate-screen v7, candidate-screen v6, posture v1, evidence v6, continuation-admission v6, and prior continuation artifacts rather than execution code",
            },
        },
        "analytics_context": {
        ...
        "diagnostic_conclusions": {
            ...
            "diminishing_returns_not_nearing": effective_diminishing_returns_class == "not_nearing_diminishing_returns",
            "circularity_risk_low": effective_circularity_class == "circularity_risk_low",
    ...
    return {
        ...
        "shadow_contract": "diagnostic_probe",
        "proposal_semantics": "diagnostic",
        "reason": "diagnostic shadow passed: the surviving next bounded continuation candidate now has an explicit governed continuation-admission v7 decision under the current narrow envelope",
        "observability_gain": {
            "passed": True,
            "reason": "the surviving candidate now has an explicit v7 admission decision and bounded envelope",
            "artifact_paths": {"governed_work_loop_continuation_admission_v7_artifact": str(artifact_path)},
        },
        "activation_analysis_usefulness": {
            "passed": True,
            "reason": "the v7 gate decides whether the frontier-circularity-boundary candidate should advance toward execution without widening posture now",
        },
        "ambiguity_reduction": {
            "passed": True,
            "score": 0.99,
            "reason": "v7 admission separates real bounded continuation from diminishing-return pressure, circularity drift, capability drift, and posture broadening",
        },
        "safety_neutrality": {
            "passed": True,
