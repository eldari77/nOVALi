...
from .v4_governed_work_loop_candidate_screen_snapshot_v5 import (
    ...
    _screen_loop_candidate_v4 as _screen_loop_candidate_v5,
)
...
def run_probe(cfg, proposal, *, rounds, seeds):
    ...
    continuation_admission_snapshot_v4 = r._load_latest_diagnostic_artifact_by_template(
    ...
    if not all(
        [
            ...
            continuation_admission_snapshot_v4,
        ...
        return {
            ...
            "reason": "diagnostic shadow failed: continuation admission v5 requires the current governed work-loop artifact chain",
            "observability_gain": {"passed": False, "reason": "missing prerequisite continuation-admission v5 artifacts"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing prerequisite continuation-admission v5 artifacts"},
            "ambiguity_reduction": {"passed": False, "reason": "missing prerequisite continuation-admission v5 artifacts"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot decide v5 admission without the local governance chain"},
        }
    ...
    if not all([directive_state, bucket_state, self_structure_state, branch_registry, recommendations]):
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: continuation admission v5 requires current directive, bucket, self-structure, branch, and recommendation state",
            ...
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot decide v5 admission without durable governance state"},
        }
    ...
    evidence_v1_artifact_path = _resolve_artifact_path(
        None,
        "memory_summary_v4_governed_work_loop_evidence_snapshot_v1_*.json",
    )
    evidence_v2_artifact_path = _resolve_artifact_path(
        None,
    ...
    continuation_admission_v4_artifact_path = _resolve_artifact_path(
    ...
    execution_v3_artifact_path = _resolve_artifact_path(
    ...
    execution_v4_artifact_path = _resolve_artifact_path(
    ...
    if not all(
        [
            ...
            continuation_admission_v4_artifact_path,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: continuation admission v5 could not resolve one or more governing artifact paths",
            "observability_gain": {"passed": False, "reason": "missing resolved continuation-admission v5 artifact paths"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing resolved continuation-admission v5 artifact paths"},
            "ambiguity_reduction": {"passed": False, "reason": "missing resolved continuation-admission v5 artifact paths"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot make a bounded v5 admission decision without the resolved local artifact chain"},
        }

    candidate_screen_summary = dict(
        _load_json_file(candidate_screen_artifact_path).get("governed_work_loop_candidate_screen_v5_summary", {})
    )
    posture_summary = dict(_load_json_file(posture_artifact_path).get("governed_work_loop_posture_summary", {}))
    evidence_v2_summary = dict(_load_json_file(evidence_v2_artifact_path).get("governed_work_loop_evidence_v2_summary", {}))
    evidence_v3_summary = dict(_load_json_file(evidence_v3_artifact_path).get("governed_work_loop_evidence_v3_summary", {}))
    evidence_v4_summary = dict(_load_json_file(evidence_v4_artifact_path).get("governed_work_loop_evidence_v4_summary", {}))
    continuation_admission_v4_summary = dict(
        _load_json_file(continuation_admission_v4_artifact_path).get("governed_work_loop_continuation_admission_v4_summary", {})
    )
    ...
    if not all(
        [
            ...
            evidence_v3_summary,
            evidence_v4_summary,
            continuation_admission_v4_summary,
        ...
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: continuation admission v5 could not load the governing summaries",
            "observability_gain": {"passed": False, "reason": "missing continuation-admission v5 summaries"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing continuation-admission v5 summaries"},
            "ambiguity_reduction": {"passed": False, "reason": "missing continuation-admission v5 summaries"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot decide v5 admission without the governing summaries"},
        }
    ...
    candidate_name = str(
        dict(candidate_screen_summary.get("top_ranked_candidate", {})).get("loop_candidate_name", "")
    ...
    if not candidate_record:
        return {
            ...
            "shadow_contract": "diagnostic_probe",
            "proposal_semantics": "diagnostic",
            "reason": "diagnostic shadow failed: the surviving v5 candidate could not be reconstructed",
            "observability_gain": {"passed": False, "reason": "missing reconstructed v5 candidate"},
            "activation_analysis_usefulness": {"passed": False, "reason": "missing reconstructed v5 candidate"},
            "ambiguity_reduction": {"passed": False, "reason": "missing reconstructed v5 candidate"},
            "safety_neutrality": {"passed": True, "reason": "no live-policy mutation occurred", "scope": str(proposal.get("scope", ""))},
            "later_selection_usefulness": {"passed": False, "reason": "cannot make a bounded decision without the surviving v5 candidate"},
        }
    ...
    admission_checks = {
        "single_surviving_candidate_confirmed": _check(
            int(candidate_screen_summary.get("credible_candidate_count", 0) or 0) == 1,
            "the v5 candidate screen must leave exactly one credible bounded candidate",
        ),
        ...
        "candidate_matches_v5_top_rank": _check(
            str(candidate_record.get("loop_candidate_name", "")) == str(dict(candidate_screen_summary.get("top_ranked_candidate", {})).get("loop_candidate_name", "")),
            "the admitted candidate must match the top-ranked v5 candidate selected by governance",
        ),
        "materially_distinct_from_reviewed_chain": _check(
            bool(distinctness.get("materially_distinct_from_chain", False)),
            "the candidate must stay materially distinct from direct work, continuation v1, continuation v2, continuation v3, continuation v4, evidence v2, evidence v3, and evidence v4",
        ),
        "likely_adds_new_evidence": _check(
            str(dict(candidate_screen_summary.get("expected_evidence_yield_assessment", {})).get("classification", ""))
            == "likely_adds_new_evidence",
        ...
        "narrow_posture_and_gate_closed": _check(
            ...
            and bool(dict(evidence_v4_summary.get("future_posture", {})).get("hold_narrow_posture_unchanged", False)),
        ...
        "repeated_bounded_success_and_clean_discipline": _check(
            str(dict(evidence_v4_summary.get("repeated_bounded_success_assessment", {})).get("classification", ""))
            == "repeated_bounded_success_strengthened"
            and str(dict(evidence_v4_summary.get("posture_discipline_assessment", {})).get("classification", ""))
            == "posture_discipline_holding_cleanly"
            and str(dict(evidence_v4_summary.get("posture_pressure_assessment", {})).get("classification", ""))
        ...
        "state_readiness_and_routing_guard": _check(
            bool(current_state_summary.get("governed_work_loop_candidate_screening_v5_in_place", False))
            and str(current_state_summary.get("latest_governed_work_loop_continuation_readiness", "")) == "ready_for_fifth_governed_work_loop_continuation_admission"
            and str(dict(candidate_screen_summary.get("recommended_next_action", {})).get("template_name", ""))
            ...
            "state must explicitly mark the fifth continuation-admission gate as ready while routing stays deferred and plan_ stays non-owning",
        ),
    ...
    admission_status = "admissible_for_governed_loop_continuation_v5" if all_checks_passed else "not_admissible_now"
    admission_rationale = (
    ...
    continuation_envelope = {
        ...
        "allowed_scope": [
            "bounded recommendation-frontier persistence boundary audit only",
    ...
    artifact_path = _diagnostic_artifact_dir() / f"memory_summary_v4_governed_work_loop_continuation_admission_snapshot_v5_{proposal['proposal_id']}.json"
    updated_self_structure_state = dict(self_structure_state)
    updated_work_loop_policy = dict(governed_work_loop_policy)
    updated_work_loop_policy["work_loop_continuation_admission_v5_schema"] = {
        "schema_name": "GovernedWorkLoopContinuationAdmission",
        "schema_version": "governed_work_loop_continuation_admission_v5",
    ...
    updated_current_state_summary.update(
        {
            "governed_work_loop_continuation_admission_v5_in_place": True,
            ...
            "latest_governed_work_loop_continuation_posture": "shadow_only_loop_continuation_v5",
            "latest_governed_work_loop_execution_readiness": (
                "ready_for_shadow_work_loop_continuation_execution_v5" if all_checks_passed else "not_ready_for_shadow_work_loop_continuation_execution_v5"
            ),
            "latest_governed_work_loop_best_next_template": next_template,
            "latest_governed_work_loop_readiness": (
                "ready_for_shadow_work_loop_continuation_execution_v5" if all_checks_passed else "ready_for_fifth_governed_work_loop_continuation_admission"
            ),
    ...
    _append_jsonl(
        SELF_STRUCTURE_LEDGER_PATH,
        {
            "event_id": f"governed_work_loop_continuation_admission_snapshot_v5::{proposal['proposal_id']}",
            "timestamp": _now(),
            "event_type": "governed_work_loop_continuation_admission_snapshot_v5_materialized",
            ...
            "paused_capability_lines_reopened": False,
            "artifact_paths": {
                "governed_work_loop_continuation_admission_v5": str(artifact_path),
                "governed_work_loop_candidate_screen_v5": str(candidate_screen_artifact_path),
                "governed_work_loop_evidence_v4": str(evidence_v4_artifact_path),
            },
    ...
    artifact_payload = {
        ...
        "template_name": "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v5",
        "branch_context": {
        ...
        "comparison_references": {
            ...
            "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v4": _artifact_reference(continuation_admission_snapshot_v4, latest_snapshots),
        ...
        "governed_work_loop_continuation_admission_v5_summary": {
            "snapshot_identity_context": {
                "snapshot_template_name": "memory_summary.v4_governed_work_loop_continuation_admission_snapshot_v5",
                "proposal_id": str(proposal.get("proposal_id", "")),
            ...
            "evidence_inputs_used": {
                "candidate_screen_snapshot_v5": str(candidate_screen_artifact_path),
                ...
                "continuation_admission_v4": str(continuation_admission_v4_artifact_path),
            ...
            "expected_evidence_yield_assessment": {
                ...
                if str(dict(candidate_screen_summary.get("expected_evidence_yield_assessment", {})).get("classification", "")) == "likely_adds_new_evidence"
                else "mostly_restates_prior_conclusions",
                "likely_adds_new_evidence": str(dict(candidate_screen_summary.get("expected_evidence_yield_assessment", {})).get("classification", "")) == "likely_adds_new_evidence",
                "likely_restates_prior_conclusions": str(dict(candidate_screen_summary.get("expected_evidence_yield_assessment", {})).get("classification", "")) != "likely_adds_new_evidence",
            },
            "posture_discipline_assessment": {"classification": "posture_discipline_preserved" if all_checks_passed else "posture_discipline_not_preserved"},
            ...
            "review_rollback_deprecation_trigger_status": {
                "review_trigger_status": {key: False for key in ["criticality", "overlap", "scope_expansion", "hidden_development_pressure"]},
                "rollback_trigger_status": {key: False for key in ["branch_mutation", "routing_drift", "plan_ownership_change"]},
                "deprecation_trigger_status": {key: False for key in ["directive_relevance_drop", "distinct_value_disappears"]},
            },
            ...
            "resource_trust_accounting": {
                "trusted_sources_in_use": list(trusted_source_report.get("requested_sources", [])),
                "expected_resource_budget": dict(dict(loop_accounting.get("resource_trust_position", {})).get("expected_resource_budget", {})),
                "approved_write_roots": list(write_root_report.get("requested_write_roots", [])),
            },
            "concise_operator_readable_conclusion": (
                "The surviving frontier-persistence candidate is admissible now under the current narrow governed envelope."
                if all_checks_passed
                else "The surviving frontier-persistence candidate is not admissible now under the current narrow governed envelope."
            ),
            ...
            "why_governance_remains_source_of_truth": {
                ...
                "reason": "continuation admission v5 is derived from directive, bucket, branch, self-structure, candidate-screen v5, posture v1, evidence v4, continuation-admission v4, and prior continuation artifacts rather than execution code",
            },
        },
        "analytics_context": {
    ...
    return {
        ...
        "shadow_contract": "diagnostic_probe",
        "proposal_semantics": "diagnostic",
        "reason": "diagnostic shadow passed: the surviving next bounded continuation candidate now has an explicit governed continuation-admission v5 decision under the current narrow envelope",
        "observability_gain": {
            "passed": True,
            "reason": "the surviving candidate now has an explicit v5 admission decision and bounded envelope",
            "artifact_paths": {"governed_work_loop_continuation_admission_v5_artifact": str(artifact_path)},
        },
        "activation_analysis_usefulness": {
            "passed": True,
            "reason": "the v5 gate decides whether the frontier-persistence candidate should advance toward execution without widening posture now",
        },
        "ambiguity_reduction": {
            "passed": True,
            "score": 0.99,
            "reason": "v5 admission separates real bounded continuation from repetition, recursion, capability drift, and posture broadening",
        },
        "safety_neutrality": {
            "passed": True,
            "scope": str(proposal.get("scope", "")),
            "reason": "the v5 admission step is diagnostic-only and changes no live behavior",
        },
